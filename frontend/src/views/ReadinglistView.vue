    ...
    <div>
        <div v-if="showClearListModal" @click="showClearListModal = false"
            ...
            <div class="w-[90%] max-w-lg bg-background-950 rounded-xl p-5 relative">
                <X class="absolute top-5 right-5 cursor-pointer" size="32" @click="showClearListModal = false" />
                <div class="text-xl">Clear List?</div>
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <button @click="() => {
                        store.clear(true)
                        showClearListModal = false
                    }" class="w-full h-14 bg-primary-600 rounded-lg transition">Remove only
        ...
        <div class="px-5 overflow-y-scroll pb-10">
            <TitleNavigationBar title="Reading List" backNavigationPath="/" class="mb-5">
                <div class="flex gap-4">
                    <ListX size="24" class="text-white cursor-pointer" @click="showClearListModal = true" />
