...
<template>
    <div>
        <div @click="toggleOptions" class="flex items-center text-left cursor-pointer">
            <div class="flex justify-between  bg-secondary-800/50 text-white p-4 rounded-lg shadow-md w-full px-4 "
                :class="{ 'rounded-b-none': showOptions }">
                <img v-if="props.feed.faviconUrl" class="w-10 h-10 me-auto" :src="props.feed.faviconUrl" alt="favicon" />
                        ...
                        <div class="flex  justify-between  ">
                            ...
                            <div class=" px-auto py-1">
                                <label class="relative inline-flex items-center me-1 cursor-pointer">
                                    ...
                                    <div class="w-11 h-6 bg-primary-500 rounded-full peer dark:bg-background-900  dark:peer-focus:ring-orange-00 peer-checked:after:translate-x-full 
