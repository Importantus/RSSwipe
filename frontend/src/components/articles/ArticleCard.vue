...
import ArticleReaders from '@/components/articles/ArticleReaders.vue'
...
<template>
  <div
    @click="openinReader"
    class="absolute w-full transitions"
    :style="{
  ...
  >
    ...
    >
      <div class="w-full flex items-center justify-between px-3 pt-3">
        <ArticleDate :article="props.article" />
        <ArticleReaders :readers="props.article.ArticleHasUser" />
      </div>
